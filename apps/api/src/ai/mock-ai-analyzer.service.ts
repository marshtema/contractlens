...
const RISK_RULES: RiskRule[] = [
  {
    ...
    suggestedFix:
      "Оплата производится в течение 30 (тридцати) календарных дней с даты подписания акта сдачи-приёмки оказанных услуг.",
    negotiationEmail:
      "Просим пересмотреть пункт о сроке оплаты. Текущая формулировка предусматривает 90 дней, что значительно превышает рыночную практику (30 дней). Для нашей компании это создаёт кассовый разрыв и фактически означает беспроцентное кредитование на 60 дней сверх нормы. Просим сократить срок до 30 дней с момента подписания акта.",
    monetaryImpact: "до 5–10% от стоимости контракта (стоимость денег за 60 дополнительных дней при ставке ЦБ).",
  },
  {
    id: "long_payment_60",
    clauseLabel: "оплата",
    ...
    suggestedFix:
      "Оплата производится в течение 30 (тридцати) календарных дней с даты подписания акта сдачи-приёмки.",
    negotiationEmail:
      "Предлагаем сократить срок оплаты с 60 до 30 дней — это соответствует рыночной практике и обеспечит более ровный кассовый поток для обеих сторон.",
    monetaryImpact: "до 3–5% от стоимости контракта (упущенная стоимость денег).",
  },
  {
    ...
    suggestedFix:
      "Совокупная ответственность Исполнителя по настоящему договору ограничена суммой фактически полученного вознаграждения по соответствующему этапу работ, но в любом случае не более общей цены договора. Стороны не несут ответственности за упущенную выгоду и косвенные убытки.",
    negotiationEmail:
      "Текущая редакция предусматривает неограниченную ответственность нашей стороны, что является нетипичным для договоров такого рода. Рыночный стандарт — лимит, равный цене договора или сумме годовых платежей. Просим добавить пункт об ограничении совокупной ответственности и исключении косвенных убытков и упущенной выгоды.",
    monetaryImpact: "неограниченно (потенциально многократно превышает цену договора).",
  },
  {
    id: "auto_renew",
    ...
    suggestedFix:
      "По истечении срока действия настоящий договор может быть продлён только по письменному соглашению сторон, оформленному не позднее чем за 30 дней до окончания срока. Автоматическая пролонгация не предусмотрена.",
    negotiationEmail:
      "Предлагаем заменить условие об автоматической пролонгации на продление по письменному соглашению сторон. Это снизит риск ненамеренной фиксации сторон на новый срок и сделает отношения более прозрачными.",
    monetaryImpact: "стоимость одного дополнительного периода действия договора.",
  },
  {
    id: "non_compete",
    ...
    suggestedFix:
      "В течение 6 (шести) месяцев с даты прекращения настоящего договора Исполнитель обязуется не оказывать аналогичные услуги прямым конкурентам Заказчика (перечисленным в Приложении №2). За соблюдение настоящего ограничения Заказчик выплачивает Исполнителю ежемесячную компенсацию в размере 50% последнего среднемесячного вознаграждения по договору.",
    negotiationEmail:
      "Текущая формулировка о неконкуренции слишком широка по сроку и сфере, а также не предусматривает компенсации. Предлагаем сократить срок до 6 месяцев, ограничить список конкретными компаниями (Приложение №2) и добавить компенсацию 50% от среднемесячного вознаграждения. В противном случае условие может быть признано судом недействительным.",
    monetaryImpact: "от 30% годовой выручки за упущенные сделки на период действия ограничения.",
  },
  {
    ...
    suggestedFix:
      "Любые изменения объёма, сроков и состава работ оформляются дополнительным соглашением сторон с одновременным пересмотром стоимости и сроков выполнения. Одностороннее изменение условий настоящим договором не допускается.",
    negotiationEmail:
      "Просим исключить условие об одностороннем изменении ТЗ. По принципу разумности, любое расширение объёма работ должно сопровождаться пересмотром цены и сроков — это защищает обе стороны от споров о приёмке и оплате.",
    monetaryImpact: "от 20% бюджета проекта (типовой объём необоплаченных «доработок»).",
  },
  {
    id: "high_penalty",
    clauseLabel: "штрафы",
    ...
    suggestedFix:
      "За просрочку исполнения обязательств виновная сторона уплачивает другой стороне неустойку в размере 0,1% от стоимости неисполненного обязательства за каждый день просрочки, но не более 10% от общей цены договора.",
    negotiationEmail:
      "Предлагаем установить симметричную и соразмерную неустойку — 0,1% в день с потолком 10% от цены договора. Текущая редакция превышает рыночную практику и может быть снижена судом (ст. 333 ГК РФ).",
    monetaryImpact: "до 10% от цены договора при максимальной просрочке.",
  },
  {
    id: "ip_transfer_all",
    clauseLabel: "права",
    ...
    suggestedFix:
      "Стороны согласовали, что вознаграждение по настоящему договору включает в себя оплату работ и стоимость передачи исключительных прав на результат работ Заказчику в полном объёме. Исполнитель сохраняет неисключительное право использовать обезличенный результат в портфолио.",
    negotiationEmail:
      "Просим явно указать, что вознаграждение покрывает как выполнение работ, так и передачу исключительных прав — это исключит будущие споры о доплате за передачу IP. Также просим сохранить за нами право на использование обезличенного кейса в портфолио.",
    monetaryImpact: "от 10% к стоимости проекта (типовая надбавка за передачу всех IP).",
  },
];
...
function detectMockRisks(text: string): RiskItem[] {
  ...
  for (const rule of RISK_RULES) {
    ...
    risks.push({
      ...
      negotiation_email: rule.negotiationEmail,
      monetary_impact: rule.monetaryImpact,
    });
  }
